...
// --- AI Bowling Constants ---
export const SWING_MAGNITUDE = 0.08; // How much the ball curves per frame
export const CUTTER_MAGNITUDE = 1.5; // How much dx changes on bounce
export const PITCH_BOUNCE_Y_POSITION = 450; // Y-coordinate where the ball should bounce